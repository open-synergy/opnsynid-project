...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo14-addon-ssi_batch_project_assignment_documenso_signing',
        ...
        'odoo14-addon-ssi_project_assignment_documenso_signing',
        ...
        'odoo14-addon-ssi_project_operating_unit',
